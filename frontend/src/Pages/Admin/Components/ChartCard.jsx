...
export default function ChartCard({
  ...
  return (
    <div className={`admin-panel premium-hover-card overflow-hidden transition-all duration-300 ${className}`}>
      <div className="p-6 border-b border-gray-100/90 bg-white/80">
      ...
      {/* Chart footer */}
      <div className="px-6 py-4 bg-gradient-to-r from-amber-50/70 to-white border-t border-gray-100">
        <div className="flex items-center justify-between text-sm">
          ...
          <button
            ...
            className="text-amber-700 hover:text-amber-800 text-sm font-semibold flex items-center px-3 py-1.5 rounded-lg hover:bg-amber-100 transition-colors"
