    ...
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl w-full max-w-sm shadow-2xl">
        ...
        <p className="text-sm text-gray-600 mb-4 text-center">
          This will delete the manager and ALL their events & tickets. This
...
export default function EventManagerDetails() {
  ...
  useEffect(() => {
    if (id) {
      ...
      dispatch(fetchAllEventManagerEvents(id));
    }
          ...
          <div className="p-6">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                The event manager could not be found.
              </p>
              <button
                onClick={() => navigate("/admin/event-managers")}
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-5 py-2.5 rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 shadow-lg hover:shadow-xl"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-6">
                  ...
                  {metrics?.monthly_breakdown?.length > 0 ? (
                    metrics.monthly_breakdown.map((row, index) => (
                      <tr key={index} className="border-b hover:bg-gray-50">
                        ...
                        <td className="p-3">
                          {row.avg_attendance?.toFixed(1) || 0}
                        </td>
                      </tr>
                    ))
                  ) : (
                  ...
                  {upcomingEvents.length > 0 ? (
                    upcomingEvents.map((e) => (
                      ...
                      >
                        ...
                        <td className="p-3">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-semibold ${e.status === "Available" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                          >
                            {e.status}
                          </span>
                        </td>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-800 pb-2 border-b border-gray-200 flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-200 p-2 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            {dateRangeEvents.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border-l-4 border-green-500">
                  ...
                  <p className="text-2xl font-bold text-gray-800">
                    {dateRangeSummary?.total_tickets_sold || 0}
                  </p>
                </div>
              </div>
            )}

            {/* Date Range Events Table */}
            <div className="overflow-x-auto">
              {loadingDateRangeEvents ? (
                  ...
                  <tbody>
                    {dateRangeEvents.map((event) => (
                      ...
                      >
                        ...
                        <td className="p-3">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-semibold ${event.status === "Available" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                          >
                            {event.status}
                          </span>
                        </td>
                ...
                <div className="text-center p-8 text-gray-500">
                  {startDate && endDate
                    ...
                    : "Select dates and click Search to filter events"}
                </div>
              ) : null}
            </div>
          </div>
