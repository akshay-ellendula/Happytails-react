        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div>
            ...
            <p className="text-white text-xs sm:text-sm">
              Your ultimate destination for discovering amazing pet events and connecting with the
          ...
          <div>
            ...
            <ul className="space-y-2 text-white text-xs sm:text-sm">
              <li>
                <a href="#" className="hover:text-[#effe8b] transition">
                  About Us
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <button className="bg-white text-[#1a1a1a] font-bold px-4 sm:px-6 py-2 rounded-full hover:bg-[#effe8b] transition text-xs sm:text-sm">
              Get Started
            </button>
          </div>
        </div>
