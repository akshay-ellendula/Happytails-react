...
import { Search, Eye, Filter, TrendingUp, ArrowRight } from "lucide-react";
      ...
      <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            ...
            <Link
              to="/shop/customers/view-all"
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white rounded-lg shadow hover:shadow-lg transition-all duration-300 font-medium"
            >
              <span>View All (Sorted)</span>
              <ArrowRight size={16} />
            </Link>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="py-4 px-6 font-semibold text-gray-600 text-sm text-center">
                  Action
                </th>
              </tr>
            </thead>
                    ...
                    <td className="py-4 px-6">
                      ...
                      <div className="h-1 bg-gray-200 rounded-full mt-2 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min((c.total_spent / 5000) * 100, 100)}%`,
                          }}
                        ></div>
                      </div>
                    </td>
