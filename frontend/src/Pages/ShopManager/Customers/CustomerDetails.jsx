...
const CustomerDetails = () => {
  ...
  // Fetch customer data once on mount
  useEffect(() => {
    axiosInstance
      .get(`/vendors/customers/${customerId}`)
      .then((res) => {
  ...
  const formatAddress = useCallback((customer) => {
    ...
    const parts = [
      candidateAddress.name,
      candidateAddress.houseNumber,
      candidateAddress.streetNo,
      candidateAddress.city,
      candidateAddress.pincode,
  ...
  const handleStatusChange = useCallback(
    async (orderId, newStatus) => {
      try {
        await axiosInstance.patch(`/vendors/orders/${orderId}/status`, {
          status: newStatus,
        });
