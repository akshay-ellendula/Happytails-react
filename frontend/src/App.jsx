...
// --- Components ---
// RoleBasedRoute import removed as it is no longer used
  ...
  return (
    <Provider store={store}>
      <Routes>
        ...
        {/* --- Formerly Protected: Customer (Now Open) --- */}
        ...
        {/* --- Formerly Protected: Booking (Now Open) --- */}
        <Route path="/booking" element={<BookingPage />} />

        {/* --- Formerly Protected: Event Manager (Now Open) --- */}
        <Route path="/eventManager/*" element={<EventManagerPage />} />

        {/* --- Formerly Protected: Store Partner (Now Open) --- */}
        <Route
          path="/store/*"
          element={<div className="p-10">Store Dashboard Coming Soon</div>}
        />

        {/* --- Formerly Protected: Admin (Now Open) --- */}
